...
Для большей наглядности представлены также два одномерных графика, показывающие профиль решения и локальную погрешность в некоторые моменты времени (\seefigref{fig:problem_2_implicit_Samarski} и \seefigref{fig:problem_2_implicit_error_Samarski})
...
Была выбрана достаточно мелкий шаг с параметрами $N_x = 5000$, $N_t = 5000$, график численного решения приведён на \figref{fig:problem_2_implicit_surface_high}.
