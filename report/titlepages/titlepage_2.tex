...
\begin{titlepage}
    ...
    \hspace*{1cm}\hspace*{-1cm}д.ф.-м.н.\hfill\hbox to\maxl{\rule{5em}{1pt} Тишкин В.Ф.\hfill}\\ \\
    \hspace*{1cm}\hspace*{-1cm}Рецензент\hfill\\
    \hspace*{1cm}\hspace*{-1cm}к.ф.-м.н.\hfill\hbox to\maxl{\rule{5em}{1pt} Фамилия И.О. \hfill}\\ \\ 
